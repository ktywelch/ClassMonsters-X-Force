...
INSERT INTO `classHeros_db`.`users` (`username`,`password`,`last_name`,`first_name`,`RoleId`,CharacterId) VALUES  
('rysmith','student','Smith','Ryan','2','2'),
('mcruz','student','Cruz','Monica','2','3'),
('jdoe','student','Doe','Jean','2','7'),
('kcat','student','Cat','Kitty','2','9');
